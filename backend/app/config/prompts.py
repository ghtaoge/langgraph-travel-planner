...
{{
  "destination": "目的地城市名",
  "duration": 旅行天数整数,
  "travel_style": "旅行风格(文化游/美食游/自然游/混合)",
  "budget_level": "预算水平(经济/中等/高端)",
  "special_requests": ["特殊需求列表"],
  "start_date": "YYYY-MM-DD或null",
  "party_size": 出行人数,
  "budget_limit": 明确预算数字或null
}}

目的地、天数和风格可以根据上下文推断；日期和明确预算未提供时必须输出 null，不得编造。"""
...
{{
  ...
  "activities": [{{
    "name": "活动名",
    "description": "活动详细描述",
    "time": "时段(如09:00-12:00)",
    "cost": 门票费用数字,
    "location": "地点"
  }}],
  "transport": "当天交通方式描述",
  "hotel_name": "推荐酒店名",
  "restaurant_names": ["推荐餐厅1", "推荐餐厅2"]
}}"""
...
{{
  ...
  "food_cost": 餐饮费用,
  "transport_cost": 交通费用,
  "activity_cost": 门票活动费用,
  "budget_breakdown": {{\"day1\": 金额, \"day2\": 金额}}
}}"""
